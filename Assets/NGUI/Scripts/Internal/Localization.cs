...
public class Localization : MonoBehaviour
{
	...
	public string currentLanguage
	{
		...
		set
		{
			if (mLanguage != value)
			{
				...
				mDictionary.Clear();
				PlayerPrefsHelper.DeleteKey("Language");
			}
		}
	}
	...
	void Awake ()
	{
		if (mInstance == null)
		{
			...
			currentLanguage = PlayerPrefsHelper.GetString("Language", startingLanguage);
	...
	public void Set (string languageName, Dictionary<string, string> dictionary)
	{
		...
		PlayerPrefsHelper.SetString("Language", mLanguage);
